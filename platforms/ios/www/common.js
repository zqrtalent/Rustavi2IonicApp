...
/***/ "./src/app/services/latestnews.service.ts":
/*!************************************************!*\
  !*** ./src/app/services/latestnews.service.ts ***!
  \************************************************/
/*! exports provided: LatestnewsService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LatestnewsService", function() { return LatestnewsService; });
...
var LatestnewsService = /** @class */ (function () {
    function LatestnewsService(http) {
        this.http = http;
        this.urlLatestNews = 'https://rustavi2webapi.herokuapp.com/api/v1/news/latest';
        this.urlNewsDetail = 'https://rustavi2webapi.herokuapp.com/api/v1/news/';
    }
    LatestnewsService.prototype.getLatestNews = function () {
        return this.http.get(this.urlLatestNews)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (results) { return results; }));
    };
    LatestnewsService.prototype.getNewsDetail = function (id) {
        return this.http.get(this.urlNewsDetail + id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (results) { return results; }));
    };
    LatestnewsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var ShowsService = /** @class */ (function () {
    function ShowsService(http) {
        this.http = http;
        this.urlShows = 'https://rustavi2webapi.herokuapp.com/api/v1/shows/';
    }
    ShowsService.prototype.getShows = function () {
        return this.http.get(this.urlShows)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (results) { return results; }));
    };
    ShowsService.prototype.getShowDetail = function (name) {
        return this.http.get(this.urlShows + name)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (results) { return results; }));
    };
    ShowsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])
